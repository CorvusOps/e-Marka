...
CREATE TABLE `writtenworks` (
  `writtenWorks_id` int(11) NOT NULL AUTO_INCREMENT,
  `writtenWorks_title` varchar(45) NOT NULL,
  `writtenWorks_total` float NOT NULL,
  `writtenWorks_subjectid` int(11) NOT NULL,
...
INSERT INTO `writtenworks` VALUES (1,'Quiz#1 - Measures of Central Tendency',30,2),(2,'Quiz#1 - Supply and Demand',20,1),(3,'Quiz#1 - Subject-Verb Agreement',30,3),(4,'Quiz#2 - Supply Chain',25,1),(5,'Quiz # 1 - Solar System',50,4),(6,'Quiz # 2 - Mars',50,4);
