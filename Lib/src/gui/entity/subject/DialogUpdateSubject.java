...
private final JPanel contentPanel = new JPanel();
	...
	public void initializeDialog(Subject subject) {
		jtxtfldName.setText(subject.getName());
		jtxtfldDescription.setText(subject.getDescription());
	}
